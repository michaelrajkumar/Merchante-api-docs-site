...
export const HOSTED_PAYMENTS_OPS: HostedPaymentsOp[] = [
  {
    slug: 'checkout',
    ...
    tag: 'Payment Request',
    description: 'Initiate Hosted Payment Page checkout',
  },
  {
    slug: 'credit-card-response',
    title: 'Credit Card Response',
    method: 'POST',
    path: '/webhooks/response-credit-card',
    tag: 'Response Handling',
    description: 'Credit card transaction response webhook',
  },
  {
    slug: 'ach-response',
    title: 'ACH Response',
    method: 'POST',
    path: '/webhooks/response-ach',
    tag: 'Response Handling',
    description: 'ACH transaction response webhook',
  },
]

export const HOSTED_PAYMENTS_TAG_ORDER = ['Payment Request', 'Response Handling']
...
export function parseHostedPaymentsSpec(yamlText: string) {
  return parseYamlSafe(yamlText)
}

export function groupOpsByTag(ops: HostedPaymentsOp[]): Map<string, HostedPaymentsOp[]> {
  const groups = new Map<string, HostedPaymentsOp[]>()
 ...
 */
export function getParameterGroups(doc: any, schema: any): ParameterGroup[] | null {
