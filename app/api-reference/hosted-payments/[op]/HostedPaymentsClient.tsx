...
import { HostedPaymentsEnvironmentSelector } from '@/components/HostedPaymentsCredentialsBox'
...
export function HostedPaymentsClient({
  operations,
  currentOp,
  miniSpec,
  codeSamples,
  ...
  const handleSubmit = async () => {
    ...
    try {
      const baseUrl = miniSpec?.servers?.[0]?.url || 'https://merchante-solutions.com/hpp'
    ...
    <div className="flex min-h-[calc(100vh-56px)]">
      ...
      <main className="flex-1 min-w-0 overflow-y-auto">
        ...
        <div className="px-4 lg:px-8 py-6 max-w-4xl mx-auto">
          ...
          {/* Code samples section - hidden for webhooks (server-to-server callbacks) */}
          ...
          <div className="mt-8">
            ...
            <CodeSampleTabs title="Form POST" samples={codeSamples} />
          </div>
          )}
